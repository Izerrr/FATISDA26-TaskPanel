  ...
  return (
    <DashboardFrame>
      <div className="space-y-6">
        ...
        {/* Repository & Course Vault Section (Front & Center!) */}
        ...
        <section>
          ...
          <div className="mt-3 grid gap-4 md:grid-cols-2">
            <Link href={`/dashboard#tasks?courseId=${course.id}`} className="group rounded-2xl border border-liquid-border bg-white p-5 shadow-glass transition hover:-translate-y-0.5 hover:border-liquid-accent/20 hover:shadow-md">
              ...
              <h2 className="mt-5 text-sm font-bold text-liquid-text">Tugas Mata Kuliah</h2>
              <p className="mt-1 text-xs leading-5 text-liquid-text-secondary">Lihat dan kelola tugas yang berkaitan dengan {course.name}.</p>
            </Link>
            ...
            <Link href={`/dashboard/schedule?courseId=${course.id}`} className="group rounded-2xl border border-liquid-border bg-white p-5 shadow-glass transition hover:-translate-y-0.5 hover:border-liquid-accent/20 hover:shadow-md">
              ...
              <h2 className="mt-5 text-sm font-bold text-liquid-text">Jadwal Perkuliahan</h2>
              <p className="mt-1 text-xs leading-5 text-liquid-text-secondary">Lihat jadwal perkuliahan mingguan untuk {course.name}.</p>
            </Link>
          </div>
        </section>
      </div>
