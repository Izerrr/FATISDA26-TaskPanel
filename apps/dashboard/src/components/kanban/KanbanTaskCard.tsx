      ...
      <div className="flex items-start justify-between gap-2.5">
        ...
        {(onEdit || onDelete || onMoveStatus) && (
          <div className="relative shrink-0" onClick={(e) => e.stopPropagation()}>
            ...
            {menuOpen && (
              <>
                {/* Backdrop to close menu on clicking space kosong */}
                <div
                ...
                <div className="absolute right-0 top-8 z-50 w-44 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900 p-1.5 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
                  {onEdit && (
                    <button
                      type="button"
                      onClick={() => {
